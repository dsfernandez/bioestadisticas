...
Vemos, entonces, que en el mundo real de los seres vivos (y de los componentes abióticos del mismo), la investigación científica se desarrolla en un marco de variación e incertidumbre.  Las estadísticas nos proveen las herramientas matemáticas para poder describir esa variación e incertidumbre, y tratar de acercarnos a una interpretación de los datos, que permita el avance de la investigación científica.

## 1.1.1.¿Para qué estadísticas?  
__Objetivo:__ Reconocer alguna aplicación de las estadísticas en la investigación biológica.
