...
Usualmente se debe comprobar antes la normalidad de la variable, pero en este caso la asumimos por información previa.  Aantes de examinar los datos, debemos formular nuestra hipótesis para no sesgar la prueba:  
$$H_0 : \mu_A = \mu_B$$  
$$H_0 : \mu_A \neq \mu_B$$  
