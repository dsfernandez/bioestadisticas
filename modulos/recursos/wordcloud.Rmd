...
detexto <- c("./Biometria_foro-datos_analisis-texto_epidemia_20200815.txt")
## ejemplo de "wordcloud" de página de internet
res <- rquery.wordcloud(detexto, type ="file",
                        lang = "spanish",
                        excludeWords = c("datos", "manejar", "covid", "epidemia", "análisis", "estadístico"),
                        textStemming = TRUE,
                        colorPalette = "Dark2",
                        min.freq = 4,
                        max.words = 100)
...
findAssocs(tdm, terms = c("salud"), corlimit = 0.1)
```
