...
#### Figura 4.  Efecto del tratamiento con una droga nueva, en pacientes con artritis, a los que se les suministró un placebo y una dosis de la droga.  

La frecuencia de casos para una variable numérica discreta, también se puede graficar mediante barras separadas.

![ __Figura 5.  Plántulas de _maple_ (arce) por parcela de un metro cuadrado.__](./imagenes/3-4 barras-frecuencia.jpg)
...
#### Figura 6.  Distribución de frecuencias de altura total de la planta (cm), en plantas de _Melocactus intortus_ del Bosque Seco de Guánica.  

Otra forma de presentar las frecuencias, es en forma acumulada:

![ __Figura 7.  Frecuencia acumulada para la longitud de 797 hembras de pez mosquito (mm), usando barras y puntos con líneas.__](./imagenes/3-10 frecuencia-acum.jpg)
\
